...
This mod manager also comes with a manager for the character/mod fixes and the funktion to run them via the mod manager. I provided the links to the downloadpages for the tool incase you don't know how to use them but most are just click and run. 
